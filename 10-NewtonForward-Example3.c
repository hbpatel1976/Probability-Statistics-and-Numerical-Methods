...
void main()
{
	float x[size]={0,1,2,3,4,5,6}, findx=2.5;
	float y[size]={0, 0.8415, 0.9093, 0.1411, -0.7568, -0.9589, -0.2794}, findy, deltay[size][size];
	float h, u;
